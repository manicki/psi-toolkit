...
boost::program_options::options_description NKJPLatticeReader::Factory::doOptionsHandled() {
    ...
    optionsDescription.add_options()
        ("layer", boost::program_options::value<std::string>()->default_value(""),
...
void NKJPLatticeReader::Worker::doRun() {
        ...
        BOOST_FOREACH(
            ...
            BOOST_FOREACH(
                ...
                try {
                    ...
                    Lattice::EdgeDescriptor segEdge
                        = appendSegmentToLattice_(segment, segItem, "token", insertSpace);
    ...
    } // end of case block (morphosyntax)
        ...
        BOOST_FOREACH(
            ...
            BOOST_FOREACH(
                ...
                try { BOOST_FOREACH(
                    ...
                    } else if (vF.second.get("<xmlattr>.name", std::string())=="nps") {
                        npsValue = vF.second.get("binary.<xmlattr>.value", npsValue);
