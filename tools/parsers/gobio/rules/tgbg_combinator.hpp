...
private:
    ...
    typename hash_wrapper<typename tgbg_combinator<T,S,M,X,E>::bid_key, typename tgbg_combinator<T,S,M,X,E>::bid_info>::type::iterator
    best_bid_(typename hash_wrapper<bid_key, bid_info>::type& bids);
