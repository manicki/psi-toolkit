...
BOOST_AUTO_TEST_CASE( conversion_int_av_to_ai ) {
    ...
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai, "1"), "2");
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai, "3"), "4");
...
BOOST_AUTO_TEST_CASE( conversion_int_ai_to_av ) {
    ...
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "1"), "2");
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "3"), "4");
...
BOOST_AUTO_TEST_CASE( conversion_partially_string ) {
    ...
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "1"), "bbb");
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "3"), "ddd");
...
BOOST_AUTO_TEST_CASE( conversion_string ) {
    ...
    AnnotationItem ai2 = converter.toAnnotationItem(avm);
    BOOST_CHECK_EQUAL(ai2.getCategory(), "category");
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "Aa"), "bbb");
    BOOST_CHECK_EQUAL(aim.getValueAsString(ai2, "Cc"), "ddd");
