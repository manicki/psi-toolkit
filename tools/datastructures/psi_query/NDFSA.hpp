...
namespace psi {
    ...
    template <typename StateT, typename ArcT>
    inline std::set<StateT> NDFSA<StateT, ArcT>
        ::deltaPrime(StateT p, typename ArcT::symbol_type a) const {
    ...
    template <typename StateT, typename ArcT>
    inline std::set<StateT> NDFSA<StateT, ArcT>
        ::delta(std::set<StateT> pSet, typename ArcT::symbol_type a) const {
