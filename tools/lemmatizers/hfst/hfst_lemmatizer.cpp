...
void HfstLemmatizer::lemmatize(const std::string & word, AnnotationItemManager & manager,
...
void HfstLemmatizer::stemsOnLemmaLevel_(const std::string &word,
...
void HfstLemmatizer::stemsOnLexemeLevel_(const std::string &word,
    LemmatizerOutputIterator & outputIterator) {
    HfstStems stems = hfstStemmer_->stem(word, *hfstAdapter_);
...
void HfstLemmatizer::stemsOnFormLevel_(const std::string &word,
    LemmatizerOutputIterator & outputIterator) {
    HfstStems stems = hfstStemmer_->stem(word, *hfstAdapter_);
