...
HfstFrenchStemmer::HfstFrenchStemmer(const boost::program_options::variables_map& options) {
}

HfstStems HfstFrenchStemmer::stem(const std::string &word, HfstAdapterInterface &hfstAdapter) {
    RegExp regTag("\\+(.*)");
    HfstStems result;
