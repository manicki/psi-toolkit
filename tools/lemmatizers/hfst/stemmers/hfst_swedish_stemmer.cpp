...
HfstSwedishStemmer::HfstSwedishStemmer(const boost::program_options::variables_map& options) {
}

HfstStems HfstSwedishStemmer::stem(const std::string &word, HfstAdapterInterface &hfstAdapter) {
    RegExp regTag("<(.*)>");
    HfstStems result;
