...
public:
    void test_simple() {
        ...
        std::list<EdgeDescriptor> ala_partition;
        ...
        std::list<EdgeDescriptor> first_blank_partition;
        ...
        std::list<EdgeDescriptor> ma_partition;
        ...
        std::list<EdgeDescriptor> second_blank_partition;
        ...
        std::list<EdgeDescriptor> kota_partition;
        ...
        std::list<EdgeDescriptor> third_blank_partition;
        ...
        std::list<EdgeDescriptor> tokens = lattice.edgesSortedTopologically(token_tag);
        std::list<EdgeDescriptor>::iterator token_iter = tokens.begin();
        TS_ASSERT_EQUALS(lattice.getEdgeAnnotationItem(*token_iter).getCategory, word_token);

        ++token_iter;
        TS_ASSERT_EQUALS(lattice.getEdgeAnnotationItem(*token_iter).getCategory, blank_token);
